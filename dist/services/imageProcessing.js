...
export class ImageProcessingService {
     ...
     */
    static async processAnswerSheet(imageBuffer, originalFileName) {
        try {
     ...
     * Analyze image quality
     */
    static async analyzeImageQuality(imageBuffer) {
        try {
     ...
     */
    static async detectAndCorrectAlignment(imageBuffer) {
        try {
     ...
     */
    static async detectRollNumber(imageBuffer) {
        try {
     ...
     */
    static calculateSharpness(stats) {
     ...
     */
    static generateIssues(qualityAnalysis, alignmentResult, rollNumberResult) {
        const issues = [];
     ...
     */
    static async batchProcessImages(images) {
        const results = [];
