...
export async function testAIConfig(req, res, next) {
    try {
        ...
        try {
            ...
            const testQuestion = await AIService.generateSingleQuestion("Mathematics", "Algebra", "UNDERSTAND", "MODERATE", "ENGLISH");
...
export async function getAIProviders(req, res, next) {
    try {
        const providers = {
            GEMINI: {
                name: "Google Gemini",
...
export async function generateQuestionsWithConfig(req, res, next) {
    try {
