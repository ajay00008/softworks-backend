...
describe('ImageProcessingService', () => {
  ...
  describe('processAnswerSheet', () => {
    ...
    it('should handle processing errors gracefully', async () => {
      ...
      await expect(
        ImageProcessingService.processAnswerSheet(mockBuffer, 'test.jpg')
      ).rejects.toThrow('Image processing failed: Invalid image data');
    });
  });
  ...
  describe('processBatch', () => {
    ...
    it('should handle mixed success and failure in batch processing', async () => {
      ...
      mockSharp.mockImplementationOnce(() => mockSharpInstance as any);
