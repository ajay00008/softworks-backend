...
export async function sendResultsToParents(req: Request, res: Response, next: NextFunction) {
  try {
...
export async function sendBulkMessage(req: Request, res: Response, next: NextFunction) {
  try {
...
export async function sendIndividualResult(req: Request, res: Response, next: NextFunction) {
  try {
...
async function sendEmailResult(email: string, resultData: any, customMessage?: string): Promise<{ success: boolean; error?: string }> {
  try {
...
async function sendWhatsAppResult(phoneNumber: string, resultData: any, customMessage?: string): Promise<{ success: boolean; error?: string }> {
  try {
...
async function sendEmailMessage(email: string, subject: string, message: string, student: any): Promise<{ success: boolean; error?: string }> {
  try {
    // Mock email sending - replace with actual email service
...
async function sendWhatsAppMessage(phoneNumber: string, message: string, student: any): Promise<{ success: boolean; error?: string }> {
  try {
    // Mock WhatsApp sending - replace with actual WhatsApp API
    console.log(`Sending WhatsApp to ${phoneNumber}:`, message);
...
function generateResultEmailMessage(resultData: any): string {
  return `
...
function generateResultWhatsAppMessage(resultData: any): string {
  return `
