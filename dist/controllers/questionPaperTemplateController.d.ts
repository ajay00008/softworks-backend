...
export declare function getDefaultTemplate(req: Request, res: Response, next: NextFunction): Promise<Response<any, Record<string, any>> | undefined>;
export declare function getTemplatesForAutoFetch(req: Request, res: Response, next: NextFunction): Promise<void>;
export declare function checkTemplatesExist(req: Request, res: Response, next: NextFunction): Promise<Response<any, Record<string, any>> | undefined>;
