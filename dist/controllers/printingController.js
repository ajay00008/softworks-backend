...
export async function printAllStudentsAnswers(req, res, next) {
    try {
...
export async function printIndividualStudentAnswer(req, res, next) {
    try {
...
export async function printClassResultsSummary(req, res, next) {
    try {
        const { examId } = req.params;
...
export async function printPerformanceReport(req, res, next) {
    try {
            ...
            const printData = {
                ...
                performance: results.map(result => ({
                    exam: {
                        ...
                        scheduledDate: result.examId.scheduledDate
                    },
                    result: {
                        totalMarksObtained: result.totalMarksObtained,
                        percentage: result.percentage,
