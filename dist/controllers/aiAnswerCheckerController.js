 ...
 */
export const checkAnswerSheetWithAI = async (req, res) => {
    try {
 ...
 */
export const batchCheckAnswerSheetsWithAI = async (req, res) => {
    try {
 ...
 */
export const overrideAIResult = async (req, res) => {
    try {
        const { answerSheetId } = req.params;
 ...
 */
export const getAnswerSheetsForAIChecking = async (req, res) => {
    try {
        const { examId } = req.params;
 ...
 */
export const recheckAnswerSheetWithAI = async (req, res) => {
    try {
        const { answerSheetId } = req.params;
        const userId = req.auth?.sub;
        if (!userId) {
...
//# sourceMappingURL=aiAnswerCheckerController.js.map