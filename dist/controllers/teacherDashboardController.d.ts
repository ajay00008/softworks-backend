...
export declare const getAssignedStudents: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
...
export declare const getTeacherExamResults: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const getTeacherExamStats: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
