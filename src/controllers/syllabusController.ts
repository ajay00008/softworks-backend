...
// Get All Syllabi
export async function getSyllabi(req: Request, res: Response, next: NextFunction) {
  try {
...
export async function updateSyllabus(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    if (updateData.subjectId || updateData.classId || updateData.academicYear) {
      ...
      if (updateData.subjectId) conflictQuery.subjectId = updateData.subjectId;
      if (updateData.classId) conflictQuery.classId = updateData.classId;
      if (updateData.academicYear) conflictQuery.academicYear = updateData.academicYear;
...
export async function getSyllabusBySubjectClass(req: Request, res: Response, next: NextFunction) {
  try {
...
export async function uploadSyllabusFile(req: Request, res: Response, next: NextFunction) {
  try {
    const { id } = req.params;
...
export async function getSyllabusStatistics(req: Request, res: Response, next: NextFunction) {
  try {
    const { academicYear } = req.query;
