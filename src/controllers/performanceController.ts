...
export async function getIndividualPerformance(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    if (queryParams.subjectId) matchQuery["exam.subjectId"] = queryParams.subjectId;
    if (queryParams.examType) matchQuery["exam.examType"] = queryParams.examType;
    if (queryParams.startDate) matchQuery["exam.scheduledDate"] = { $gte: queryParams.startDate };
    if (queryParams.endDate) matchQuery["exam.scheduledDate"] = { ...matchQuery["exam.scheduledDate"], $lte: queryParams.endDate };
...
export async function getClassPerformance(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    const matchQuery: any = { "student.classId": classId };
    if (queryParams.subjectId) matchQuery["exam.subjectId"] = queryParams.subjectId;
    if (queryParams.examType) matchQuery["exam.examType"] = queryParams.examType;
    if (queryParams.startDate) matchQuery["exam.scheduledDate"] = { $gte: queryParams.startDate };
    if (queryParams.endDate) matchQuery["exam.scheduledDate"] = { ...matchQuery["exam.scheduledDate"], $lte: queryParams.endDate };
...
export async function getPerformanceAnalytics(req: Request, res: Response, next: NextFunction) {
  try {
    ...
    if (queryParams.classId) matchQuery["student.classId"] = queryParams.classId;
    if (queryParams.subjectId) matchQuery["exam.subjectId"] = queryParams.subjectId;
    if (queryParams.examType) matchQuery["exam.examType"] = queryParams.examType;
    if (queryParams.startDate) matchQuery["exam.scheduledDate"] = { $gte: queryParams.startDate };
    if (queryParams.endDate) matchQuery["exam.scheduledDate"] = { ...matchQuery["exam.scheduledDate"], $lte: queryParams.endDate };
...
export async function getPerformanceReport(req: Request, res: Response, next: NextFunction) {
  try {
