...
export class FileStorageService {
    ...
    static BOOKS_FOLDER = path.join(this.PUBLIC_FOLDER, 'books');
    static QUESTION_PAPERS_FOLDER = path.join(this.PUBLIC_FOLDER, 'question-papers');
    static UPLOADS_FOLDER = path.join(this.PUBLIC_FOLDER, 'uploads');
    /**
     ...
     * Get file path
     */
    static getFilePath(fileName, folder) {
        return path.join(this.PUBLIC_FOLDER, folder, fileName);
    }
    /**
     * Check if file exists
     */
    static fileExists(fileName, folder) {
     ...
     * Get file info
     */
    static getFileInfo(fileName, folder) {
        try {
            const filePath = this.getFilePath(fileName, folder);
            if (fs.existsSync(filePath)) {
