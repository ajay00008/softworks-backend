...
const CreateSubjectSchema = z.object({
  ...
  category: z.enum(["SCIENCE", "MATHEMATICS", "ENGLISH", "HINDI", "LANGUAGES", "SOCIAL_SCIENCES", "HISTORY", "GEOGRAPHY", "CIVICS", "ECONOMICS", "COMMERCE", "ACCOUNTANCY", "BUSINESS_STUDIES", "ARTS", "PHYSICAL_EDUCATION", "COMPUTER_SCIENCE", "INFORMATION_TECHNOLOGY", "OTHER"]),
...
const UpdateSubjectSchema = z.object({
  ...
  category: z.enum(["SCIENCE", "MATHEMATICS", "ENGLISH", "HINDI", "LANGUAGES", "SOCIAL_SCIENCES", "HISTORY", "GEOGRAPHY", "CIVICS", "ECONOMICS", "COMMERCE", "ACCOUNTANCY", "BUSINESS_STUDIES", "ARTS", "PHYSICAL_EDUCATION", "COMPUTER_SCIENCE", "INFORMATION_TECHNOLOGY", "OTHER"]).optional(),
