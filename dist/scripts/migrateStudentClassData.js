            ...
            try {
                ...
                if (!classId) {
                    ...
                    if (match) {
                        ...
                        const matchingClass = classes.find(cls => cls.level === level && cls.section === section);
                        if (matchingClass) {
...
async function createMissingClasses() {
    ...
    const uniqueClassNames = [...new Set(studentsWithClassName.map(s => s.className))];
...
//# sourceMappingURL=migrateStudentClassData.js.map