...
export interface IQuestionPaper extends Document {
  ...
  // Mark distribution - exactly as requested
  markDistribution: {
    oneMark: number; // Number of 1-mark questions
  ...
  // Bloom's taxonomy distribution with percentages
  bloomsDistribution: {
  ...
  aiSettings?: {
    ...
    twistedQuestionsPercentage: number; // 0-50%
    useSubjectBook: boolean; // Whether to use the uploaded subject book
  };
...
export const QuestionPaper: Model<IQuestionPaper> = mongoose.models.QuestionPaper || mongoose.model<IQuestionPaper>("QuestionPaper", QuestionPaperSchema);